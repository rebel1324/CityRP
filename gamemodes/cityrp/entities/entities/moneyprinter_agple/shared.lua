...
function ENT:SetupDataTables()
	...
	self.CrclCfg.Name = "printerNameApple" -- The name of the printer...
	self.CrclCfg.FireUpChance = 30 -- Printer break chance
	self.CrclCfg.MaxMoney = 800 -- Max money that it can hold
	self.CrclCfg.PrintInterval = 25 -- Interval in sec that it prints
	self.CrclCfg.PrintRate = 75 -- Prints this amount of the money if it have 100% upgraded speed + exp money added to this 1lvl = 1/4 of this number
	self.CrclCfg.PlusMoney = 70 -- 기초 돈복사량
