...
if (SERVER) then
    ...
    local function renderCode(self, ent, w, h)
        ...
        if (false and char) then
            ...
            do
                nut.util.drawText("Goverment Fund", w / 2 + scroll, scale * 52, color_white, 1, 1, "nutFedSubTitle")
                nut.util.drawText(nut.currency.get(100000), w / 2 + scroll, scale * 66, color_white, 1, 1, "nutFedTitle")
            end

            do
                nut.util.drawText("Citizens in the City", w / 2 + w + scroll, scale * 52, color_white, 1, 1, "nutFedSubTitle")
                local time = Format("%s Citizens", players)
                nut.util.drawText(time, w / 2 + w + scroll, scale * 66, color_white, 1, 1, "nutFedTitle")
            end
            ...
            do
                ...
                nut.util.drawText("Bankrobbery", w / 2 + w * 2 + scroll, scale * 52, color_white, 1, 1, "nutFedSubTitle")
                nut.util.drawText(text, w / 2 + w * 2 + scroll, scale * 66, color_white, 1, 1, "nutFedTitle")
            end
            ...
            do
                ...
                nut.util.drawText("Arrested Convicts", w / 2 + w * 3 + scroll, scale * 52, color_white, 1, 1, "nutFedSubTitle")
                nut.util.drawText(num .. "Convicts", w / 2 + w * 3 + scroll, scale * 66, color_white, 1, 1, "nutFedTitle")
            end

            do
                nut.util.drawText("Goverment Fund", w / 2 + w * 4 + scroll, scale * 52, color_white, 1, 1, "nutFedSubTitle")
                nut.util.drawText(nut.currency.get(100000), w / 2 + w * 4 + scroll, scale * 66, color_white, 1, 1, "nutFedTitle")
            end
        end
    end
