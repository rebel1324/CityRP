...
function ENT:Initialize()
    ...
    timer.Simple(self.PrintRate, function()
        if IsValid(self) then
            self:Work()
        end
    end)
    ...
    if (IsValid(entity) and IsValid(client)) then
        ...
        if (char) then
            if (upgNum == 11) then
                ...
                if (not char:hasMoney(money) or entity.PowerConsume >= 3) then return end
            ...
            elseif (upgNum == 2) then
                ...
                sound.Play("buttons/button15.wav", entity:GetPos(), 100, 100, 1)
                if (not char:hasMoney(money) or entity.Stability >= 3) then return end
                client:notifyLocalized("printerCoolerUpgrade")
            ...
            elseif (upgNum == 3) then
                ...
                sound.Play("buttons/button15.wav", entity:GetPos(), 100, 100, 1)
                if (not char:hasMoney(money) or entity.Cooler == true) then return end
                client:notifyLocalized("printerCoolerUpgrade")
                entity.Cooler = true
            ...
            elseif (upgNum == 4) then
                ...
                sound.Play("buttons/button15.wav", entity:GetPos(), 100, 100, 1)
                if (not char:hasMoney(money) or entity.PlusSpeed >= 100) then return end
