...
function ENT:SetupDataTables()
	...
	self.CrclCfg.Name = "printerNameSamsung" -- The name of the printer...
	self.CrclCfg.FireUpChance = 70 -- Printer break chance
	self.CrclCfg.MaxMoney = 800 -- Max money that it can hold
	self.CrclCfg.PrintInterval = 45 -- Interval in sec that it prints
	...
	self.CrclCfg.PlusMoney = 50 -- 기초 돈복사량

	self.CrclCfg.SpeedUpgradePrice = 30 -- Price for the speed upgrade
	self.CrclCfg.CoolingUpgradePrice = 1400 -- Price for the cooling upgrade
