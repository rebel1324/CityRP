LANGUAGE = {
    ...
    arrestNotify = "%s님이 %s님을 체포하였습니다. (수감시간 %s초)",
    warrantNofity = "%s님이 %s님에게 수색영장이 발부되었습니다. (%s)",
    warrantLiftNofity = "%s님이 %s님에게 발급된 수색영장을 기각했습니다.",
    legBroken = "다리 부러짐",
    protected = "보호됨 (%s%%)",
	...
	shipmentItemDesc = "특정 물건이 여러개 들어있는 상자 (%sx%s)",
	...
	noExploitPlease = "새로운 캐릭터는 이미 기존에 시작 자금을 받았기 때문에 자금을 받지 않습니다.",
    quickGiveMoney = "돈 주기",
    quickDropMoney = "돈 버리기",
    quickUseTie = "수갑 사용",
    quickSearchPlayer = "플레이어 수색",
    quickSetPassword = "패스워드 설정",
    quickRefund = "이 엔티티 환불",
    quickBuyDoor = "문 사기",
    quickSellDoor = "문 팔기",
    quickCreateLawboard = "법판 소환",
    quickSetPrice = "가격 설정",
    quickGiveLicense = "라이센스 주기",
    quickRevokeLicense = "라이센스 뺏기",
    quickCenter = "빠른 명령어",
    quickHelp = "원하시는 기능으로 마우스를 움직이고 C버튼을 떼면 명령어가 실행됩니다.",
    ctrlInv2 = "\"쉬프트\" + 클릭으로 빠른 나누기",
    noOrg = "소속 단체 없음",
    printerToggled = "프린터 상태를 변경했습니다: %s",
    tryLater = "%s초후 다시 시도해주세요",
	moneyPrinterHelp2 = "돈이 없는 상태에서 사용하면 전원을 토글합니다.",
    purchaseItem = "구매하기 %s.",
    unwantedNotify = "%s님의 현상수배가 해제되었습니다.",
    lockdownOn = "계엄령이 선포되었습니다! 모두 집안에 들어가세요!",
    ["Zip Ties"] = "수갑",
    
    organization = "단체",
    orgCreateInfo = "여기서 새로운 단체를 만들 수 있습니다.",
    orgTitle = "단체 이름",
    orgDesc = "단체 설명",
    orgJoinDesc = "이 도시에 있는 단체 목록입니다.",
    orgCreateDesc = "새로운 단체 생성",
    orgCreate = "생성",
    orgJoin = "입장",
    noSpace = "인벤토리에 공간이 없습니다.",
	radioNoRadioComm = "주변 또는 인벤토리에 통신 가능한 라디오가 없습니다.",
	
	unstuckOngoing = "스폰포인트로 돌아가는 중입니다. %s초뒤 돌아갑니다.",
	unstuckInturrupted = "스폰포인트로 돌아가는데 실패했습니다. %s초뒤 다시 시도하세요.",
	removedLawboard = "법판을 삭제하였습니다",
	notOnSearch = "현새 수색중이 아닙니다.",

    quickWarrant = "영장 발부기 열기",
    quickRemoveLawboard = "법판 삭제",
    quickCreateLawboard = "법판 생성",
    quickLawMenu = "법판 에디터 열기",
    goWanted = "현상수배",
    goWarrant = "수색영장",
    gobackWanted = "수배해제",
    gobackWarrant = "수색해제",
