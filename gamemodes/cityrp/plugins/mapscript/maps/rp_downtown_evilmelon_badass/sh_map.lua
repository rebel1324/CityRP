    ...
    function PLUGIN:OnPlayerJoinClass(client, class, oldclass, silent)
        ...
        if (bool) then
            ...
            if (ocData and ncData) then
                if (ocData.law and not ncData.law) then
...
if (SERVER) then
    ...
    netstream.Hook("nutJailDoor", function(client, arg)
        if (JAIL_CONTROLLER_DELAY > CurTime()) then
            return
        end
...
은행 내부에 바리케이트를 설치하는 순간 서버의 규칙에 따라서 처벌될 것입니다. ]], SCREEN_2:getWide() - 20)
        end)
        ...
        SCREEN_2.onMouseClick = function(self, key) end
...
하지만, IC에서의 강등이 매우 많아지면 OOC로써 취급되어 서버의 규칙에 따라 처벌받을 수 있습니다.]], SCREEN_3:getWide() - 20)
        end)
        ...
        SCREEN_3.onMouseClick = function(self, key) end
    ...
    do
        local labelChange = {
            ...
            files = {"cell1", "cell2", "cell3", "cell4", "cell5", "cell6", "cell7", "info1", "info2", "jailbutton"}
        }

        local decalChange2 = {{"decals/decalgraffiti001c_cs", "translation/decalgraffiti001c"}, {"decals/decal_signprotection009a", "translation/decal_signprotection009a"}, {"de_train/train_security_decal_01", "translation/train_security_decal_01"}, {"de_train/train_security_decal_02", "translation/train_security_decal_02"}, {"decals/decal_posters006a", "translation/decal_posters006a"}, {"decals/decal_posterbreen", "translation/decal_posterbreen"}, {"cs_assault/assault_parking_decal01", "translation/assault_parking_decal01"}, {"decals/decalposter007a", "translation/decalposter007a"}, {"decals/decalgraffiti043a_cs", "translation/decalgraffiti043a_cs"}, {"decals/decalgraffiti050a", "translation/decalgraffiti050a"}, {"decals/decalgraffiti009a", "translation/decalgraffiti009a"}}

        local propChange = {
            dir = {"props/", "translation/"},
            files = {"metalsign001i", "sign_cafe01a", "signhostel001a", "sign_foto01a"}
        }
