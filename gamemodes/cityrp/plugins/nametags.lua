...
local txt = {{75, "injured1"}, {50, "injured2"}, {25, "injured3"}}
btNameTag = {}
...
btNameTag.info = {
    ...
    },
    {
        ...
        doDraw = function(client, ntX, ntY, ntCol) return btNameTag:drawText(L"legBroken", ntX, ntY, ColorAlpha(ntWanted, ntCol.a), 1) end
    },
    {
    ...
    },
    {
        ...
        doDraw = function(client, ntX, ntY, ntCol) return btNameTag:drawText(L"stunned", ntX, ntY, ColorAlpha(ntAFK, ntCol.a), 1) end
    },
    {
        canDraw = function(client, char) return not client:Alive() end,
        doDraw = function(client, ntX, ntY, ntCol) return btNameTag:drawText(L"dead", ntX, ntY, ColorAlpha(ntWanted, ntCol.a), 1) end
    },
    {
    ...
    },
    {
        ...
        doDraw = function(client, ntX, ntY, ntCol) return btNameTag:drawText(L"onHit", ntX, ntY, ColorAlpha(ntWanted, ntCol.a), 1) end
    },
    {
        canDraw = function(client) return false end,
        doDraw = function(client, ntX, ntY, ntCol) return btNameTag:drawText(L"afk", ntX, ntY, ColorAlpha(ntAFK, ntCol.a), 1) end
    },
    {
        canDraw = function(client) return client:getNetVar("restricted") end,
        doDraw = function(client, ntX, ntY, ntCol) return btNameTag:drawText(L"tied", ntX, ntY, ColorAlpha(ntWanted, ntCol.a), 1) end
    },
    {
        canDraw = function(client) return client:getNetVar("hitman") == ntLocalPlayer end,
        doDraw = function(client, ntX, ntY, ntCol) return btNameTag:drawText(L"hitTarget", ntX, ntY, ColorAlpha(ntWanted, ntCol.a), 1) end
    },
    {
        canDraw = function(client) return client:getNetVar("license", false) end,
        doDraw = function(client, ntX, ntY, ntCol) return btNameTag:drawText(L"hasLicense", ntX, ntY, ColorAlpha(ntGood, ntCol.a), 1) end
    },
    {
        canDraw = function(client) return client:getNetVar("searchWarrant", false) end,
        doDraw = function(client, ntX, ntY, ntCol) return btNameTag:drawText(L"onWarrant", ntX, ntY, ColorAlpha(ntGood, ntCol.a), 1) end
    },
    {
        canDraw = function(client, char) return char:getData("wanted") end,
        doDraw = function(client, ntX, ntY, ntCol) return btNameTag:drawText(L"onWanted", ntX, ntY, ColorAlpha(ntWanted, ntCol.a), 1) end
    },
    {
        canDraw = function(client) return client:isArrested() end,
        doDraw = function(client, ntX, ntY, ntCol) return btNameTag:drawText(L"arrested", ntX, ntY, ColorAlpha(ntWanted, ntCol.a), 1) end
    }
}

btNameTag.font = {"btNameTag_font", "btNameTag_blur", "btNameTag_small", "btNameTag_ssmall"}
btNameTag.afkPhrases = {"AFK"}

hook.Add("LoadFonts", "nutFontNametag", function(font, genericFont)
    for i = 0, 1 do
        surface.CreateFont(btNameTag.font[1 + 2 * i], {
            font = font,
            size = 100 - 40 * i,
            weight = 800,
            antialias = true,
        ...
        surface.CreateFont(btNameTag.font[2 + 2 * i], {
            font = font,
            size = 100 - 40 * i,
            weight = 800,
            antialias = true,
        ...
        if (ntChar or client:IsBot()) then
            ...
            xpcall(function()
                ...
                if (description and description ~= "") then
                    if (not client.oldDesc or client.oldDesc ~= description) then
