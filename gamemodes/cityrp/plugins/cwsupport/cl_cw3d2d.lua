...
local function CW20_HUD_REPLACEMENT()
    ...
    surface.CreateFont("CW_KillIcons", {
        font = "csd",
        extended = true,
        size = ScreenScale(20),
        weight = 500,
    ...
    surface.CreateFont("CW_SelectIcons", {
        font = "csd",
        extended = true,
        size = ScreenScale(60),
        weight = 500,
    ...
    surface.CreateFont("CW_KillIcons2", {
        font = "HalfLife2",
        extended = true,
        size = ScreenScale(30),
        weight = 500,
    ...
    surface.CreateFont("CW_SelectIcons2", {
        font = "HalfLife2",
        extended = true,
        size = ScreenScale(60),
        weight = 500,
