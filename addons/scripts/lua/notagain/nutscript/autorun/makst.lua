    ...
    signal.list = {
        ...
        },
        {
            ...
            canDisplay = function(client, target)
                ...
                if (not classData or not classData.law) then return end
                if (not target:IsPlayer()) then return end
    ...
    if (MODERNRP) then
        table.insert(signal.list, {
            ...
            canDisplay = function(client, target)
                if (not IsValid(target)) then return end
                if (target:CPPIGetOwner() ~= client) then return end
                if (not nut.bent.list[target:GetClass()]) then return end
        ...
        table.insert(signal.list, {
            ...
            canDisplay = function(client, target)
                if (not IsValid(target)) then return end
                if (not target:isDoor()) then return end
        ...
        table.insert(signal.list, {
            ...
            canDisplay = function(client, target)
                if (not IsValid(target)) then return end
                if (target:CPPIGetOwner() ~= client) then return end
                if (not target.vending) then return end
        ...
        table.insert(signal.list, {
            ...
            canDisplay = function(client, target)
                ...
                if (not classData or not classData.law) then return end
                if (not target:IsPlayer()) then return end
                if (not target:getNetVar("license")) then return end
