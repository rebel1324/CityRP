    ...
    signal.list = {
        ...
        },
        {
            ...
            canDisplay = function(client, target)
                ...
                if (not classData or not classData.law) then
                    return
                end
        ...
        },
        {
            ...
            canDisplay = function(client, target)
                ...
                if (target:GetClass() ~= "nut_keypad") then
                    return
                end
    ...
    if (MODERNRP) then
        table.insert(signal.list, {
            ...
            canDisplay = function(client, target)
                ...
                if (not nut.bent.list[target:GetClass()]) then
                    return
                end
        ...
        table.insert(signal.list, {
            ...
            canDisplay = function(client, target)
                ...
                if (not target:isDoor()) then
                    return
                end

                if (IsValid(target:GetDTEntity(0))) then
                    return
                end
        ...
        table.insert(signal.list, {
            ...
            canDisplay = function(client, target)
                ...
                if (target:GetDTEntity(0) ~= client) then
                    return
                end
        ...
        table.insert(signal.list, {
            ...
            canDisplay = function(client, target)
                ...
                if (target:getNetVar("license")) then
                    return
                end
        ...
        table.insert(signal.list, {
            ...
            canDisplay = function(client, target)
                ...
                if (not target:getNetVar("license")) then
                    return
                end
    ...
    if (SERVER) then
        local function BotTimeOut()
            for k, v in pairs(player.GetBots()) do
                if not v.BotEndTime then
                    v.BotEndTime = CurTime() + 1800
                elseif v.BotEndTime < CurTime() then
                    v:Kick("Bot TimeOut")
                end
            end
        end
        ...
        -- You're playing for X hours.
    else
        local hour = 0

        local function TimeAfter()
            hour = hour + 1
            chat.AddText(Color(255, 150, 230), L("clientPlay", hour))
        end
