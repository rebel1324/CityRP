...
hook.Add("InitializedPlugins", "hudLanguage", languageDeclare)
...
local informationDraw = {
    ...
    nut_keys = function()
                    ...
                    if (ent) then
                        ...
                        if (dist <= 128) then
                            if (ent:isDoor()) then
                                drawIconText(1, 0, sw/2, sh/3*2, L"helpKey1")
                                drawIconText(0, 0, sw/2, sh/3*2+iconSize, L"helpKey2")
...
local displayInfo = {
    ...
    nut_attrib_gun = {"tipMedven", 0, 0},
    nut_attrib_punch = {"tipMedven", 0, 0},
...
hook.Add("HUDPaintBackground", "nutNoobHelper", function()
...
hook.Add("HUDPaint", "nutNoobHelper", function()
...
hook.Add("SetupQuickMenu", "nutNoobHelper", function(menu)
